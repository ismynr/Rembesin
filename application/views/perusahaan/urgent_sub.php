    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card bg-warning mb-4 row ml-1 mr-1">
            <div class="card-body p-3">
              <h5 class="m-0 font-weight-bold text-white"><a href="<?= site_url('perusahaan/urgent') ?>" class="text-white"><i class="fas fa-arrow-alt-circle-left mr-3" style="font-size: 20px;" data-toggle="tooltip" data-placement="bottom" title="Kembali"></i></a>Detail Rembes URGENT<?= $total_rembes < $uang_lumpsum ? '<p class="kat-purple ml-3">Nota</p>':'<p class="kat-orange ml-3">Pengajuan</p>' ?></h5>
            </div>
          </div>
          ...
          <div class="card shadow mb-4 mt-4">
            <div class="card-header bg-warning py-3">
              <h6 class="m-0 font-weight-bold text-white float-left mt-2">List Nota Rembes</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
...
<script type="text/javascript">
  $(document ).ready(function(){
    ...
    $('#dataTable').DataTable({
      ...
      "order":[],
      "ajax":{
        url:"<?= site_url('perusahaan/urgent/list_rembes/fetch') ?>",
        type:"POST",
        data:function(data){
