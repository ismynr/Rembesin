    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card border-bottom-primary mb-4 row ml-1 mr-1">
            <div class="card-body bg-primary p-3">
              <h5 class="m-0 font-weight-bold text-white"><a href="<?= site_url('karyawan/lap_dataRembes/unclaimed') ?>" class="text-white"><i class="fas fa-arrow-alt-circle-left mr-3" style="font-size: 20px;" data-toggle="tooltip" data-placement="bottom" title="Kembali"></i></a>Detail Rembes <?= $total_rembes < $uang_lumpsum ? '<p class="kat-purple ml-3">Nota</p>':'<p class="kat-orange ml-3">Pengajuan</p>' ?></h5>
            </div>
          </div>
              ...
              <div class="table-responsive">
                <table class="table table-borderless table-sm" width="100%" cellspacing="0">
                  <thead>
                    ...
                    <!-- <tr> -->
                      <?php if($tanggal_submit != "0000-00-00" && $tanggal_selesai != "0000-00-00"): ?>
                        <?php if($uang_lumpsum < $total_rembes): ?>
                          <?php if($norek != null): ?>
                            <tr>
                              ...
                              <th width="2%">:</th>
                              <td><?= $uang_lumpsum - $total_rembes ?></td>
                            </tr>
                            <tr>
...
<script type="text/javascript">
  $(document ).ready(function(){
    ...
    $('#dataTable').DataTable({
      ...
      "order":[],
      "ajax":{
        url:"<?= site_url('karyawan/lap_dataRembes/unclaimed/list_rembes/fetch') ?>",
        type:"POST",
        data:function(data){
